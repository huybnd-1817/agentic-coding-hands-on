...
insert into public.awards (code, name_en, name_vi, description_en, description_vi, sort_order, quantity, quantity_unit, prize_value_individual, prize_value_team, prize_note)
values
  (
    'top_talent',
    'Top Talent',
    ...
    1, 10, 'Cá nhân', '7.000.000 VNĐ', NULL, 'cho mỗi giải thưởng'
  ),
  (
    'top_project',
    'Top Project',
    ...
    2, 2, 'Tập thể', '15.000.000 VNĐ', NULL, 'cho mỗi giải thưởng'
  ),
  (
    'top_project_leader',
    'Top Project Leader',
    ...
    3, 3, 'Cá nhân', '7.000.000 VNĐ', NULL, 'cho mỗi giải thưởng'
  ),
  (
    'best_manager',
    'Best Manager',
    ...
    4, 1, 'Cá nhân', '10.000.000 VNĐ', NULL, 'cho mỗi giải thưởng'
  ),
  (
    'signature_2026_creator',
    ...
    5, 1, 'Cá nhân hoặc tập thể', '5.000.000 VNĐ', '8.000.000 VNĐ', 'cho giải cá nhân'
  ),
  (
    'mvp',
    ...
    6, 1, 'Cá nhân', '15.000.000 VNĐ', NULL, 'cho giải cá nhân'
  )
on conflict (code) do update set
  ...
  prize_value_individual = excluded.prize_value_individual,
